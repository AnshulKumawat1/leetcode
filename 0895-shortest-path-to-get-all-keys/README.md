<h2><a href="https://leetcode.com/problems/shortest-path-to-get-all-keys/description/">895. Shortest Path to Get All Keys</a></h2><h3>Hard</h3><hr><p>You are given an <code>m x n</code> grid <code>grid</code> where:</p>
